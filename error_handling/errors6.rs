...
impl ParsePosNonzeroError {
    ...
    fn from_creation(
        ...
        match err {
            ...
            // Creation => PositiveNonzeroInteger::Creation(CreationError::Negative),
            // ParseInt => ParsePosNonzeroError::Creation(CreationError::Zero),
        }
    }
}
...
impl PositiveNonzeroInteger {
    fn from_creation(err: CreationError) -> ParsePosNonzeroError {
        match err {
            CreationError::Zero | CreationError::Negative => {
